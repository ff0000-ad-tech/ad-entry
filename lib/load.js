// import { fbaDataToBlobs } from '@ff0000-ad-tech/ad-global'

export const loadScripts = async () => {
	await Promise.all(
		window.adParams.dependencies.map(dep => {
...
export const loadFonts = async () => {
	/* TODO: 
		- Webpack writes paths to font-assets in index
		- fonts are added to dom
		- load complete is monitored
	*/
}
export const loadImages = async () => {
	/* TODO: 
		- Webpack writes paths to image-assets in index
		- imgs are added to dom
		- load is monitored
		- images are passed to build for ImageManager
	*/
	return []
}
...
// 				}
// 			}
// 			req.open('GET', window.assets.payload.binary[0], true)
